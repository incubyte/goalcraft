...
export default function OKRDisplay({
  ...
  const { objectives, setObjectives, isWaitingForResponse } =
      ...
      {objectives != null && objectives.length > 0 ? (
        objectives.map((objective, objectiveIdx) => {
          return (
            ...
            >
              {objective.id === objectiveForUpdate.id &&
                ...
                objective.keyResults.map((keyResult, index) => (
                  ...
                  >
                    ...
                    >
                      ...
                      <p
                        className={`text-primary text-xs w-full p-2 font-medium rounded-md`}
                      >
                        {keyResult.title}
                      </p>
                    </div>
                    ...
                    <meter
                      ...
                      low={getProgressThreshold(
                        keyResult.targetValue,
                        PROGRESS_THRESHOLD.LOW
                      )}
                      high={getProgressThreshold(
                        keyResult.targetValue,
                        PROGRESS_THRESHOLD.HIGH
                      )}
                    ...
                    <div className="flex w-full font-medium items-center justify-between">
                      <p className="text-xs">
                        ...
                        <span className="text-gray-500">
                          {keyResult.targetValue} (Progress)
                        </span>
                      </p>
        ...
        <div className="w-full h-full flex flex-col items-center justify-center">
          ...
          <p className="mt-6 font-medium text-gray-700">
            Ready to <span className="text-primary">level up?</span> Set your
            first goal.
          </p>
        </div>
      )}
