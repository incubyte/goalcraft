    ...
    return (
        <section className="relative w-screen h-screen flex flex-col justify-center gap-y-32 items-center">
            ...
            <div className="absolute bottom-16">
                <p className="flex gap-x-1 items-center text-base font-medium">Powered by <img width={90} src="https://cdn.prod.website-files.com/6626410e05635d300b393781/6626470cbc8d6debaaa5adeb_Incubyte%20Logo.svg" alt="incubyte"/>
                </p>
            </div>
        </section>
    )
